...
<ul>
	...
	<li class="em-cart-widget-total"><?php echo $EM_Multiple_Booking->get_spaces(true); ?> <?php _e('Spaces','dbem'); ?> - <?php echo $EM_Multiple_Booking->get_price(true, true, true); ?></li>
