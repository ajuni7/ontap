...
Total : <?php echo $EM_Booking->get_price(false, true); ?>
...
Sub Total : <?php echo $EM_Multiple_Booking->get_price(false,true,false); ?>

Taxes : <?php echo em_get_currency_formatted($EM_Multiple_Booking->get_price(false,false,false) * (get_option('dbem_bookings_tax')/100)); ?>

Total with Taxes : <?php echo $EM_Multiple_Booking->get_price(false,true,true); ?>
<?php else: ?>

Total : <?php echo $EM_Multiple_Booking->get_price(false,true,true); ?>
<?php endif; ?>